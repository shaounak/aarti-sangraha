...
% Use a Devanagari font for Marathi and a separate Latin font for transliterations.
\setmainfont[Script=Devanagari, Mapping=devanagarinumerals]{Lohit Devanagari}
...
\begin{flushleft}
  ...
  दर्शनमात्रे मन, स्मरणेमात्रे मनकामना पुरती, जय देव, जय देव ॥धृ॥ \\
  \rule{\linewidth}{1pt} \\
  % -------------------------------------- \\
  ...
  kanthi jhalke mala, muktaphalanchi ।। 1 ।। \\
  \rule{\linewidth}{1pt} \\
  jai dev, jai dev jai mangalmurti, ho shri mangalmurti । \\
  darshanamatre man, smaranamatre manakamana purti, jai dev, jai dev । \\
  \rule{\linewidth}{1pt} \\
  ...
  charanichya ghagariya runajhun vajati ।। \\
  tethe nande deva ambar garjati । \\
  tata thumakat thumakat nache ganpati ।। \\
  tav shankar parvati kautuk pahati ।। 2 ।।\\
  \rule{\linewidth}{1pt} \\
  lambodar pitambar, phanivarabandhana । \\
  saral sond, vakratund trinayana ।। \\
  das ramacha, vat pahe sadana । \\
  sankati pavave, nirvani rakshave, suravaravandana ।। \\
  jai dev jai dev, jay mangalmurti । \\
  darshanamatre manakamana purti ।। 3 ।। \\
\end{flushleft}
% \end{multicols}
% -------------------------------------- \\
\pagebreak
...
\begin{flushleft}
  ...
  \pagebreak
  \subsection*{english}
  durge durghat bhari tujavin sansari \ anathanathe ambe karuna vistari \ vari vari janmamaranate vari \ hari padalo ata sankat nivari \\
  \rule{\linewidth}{1pt} \\
  jay devi jay devi jay mahishasuramathani, \ o daityasuramathani \ suravaraishvaravarade tarak sanjivani \\
  \rule{\linewidth}{1pt} \\
  tribhuvani bhuvani pahtana tuj se nahi \ chari shramale parantu n bolave kahin \ sahi vivad karitana padile pravahi \ te tu bhaktalagi, te tu dasalagi, pavasi lavalahi \\
  \rule{\linewidth}{1pt} \\
  prasann vadane prasann hosie nijadasa \ kleshapasuni sodi, duhkhanapasun sodavi, todi bhavpasha \ ambe tujavanchuna kon purvil asha \ narhari tallin jhala padapankajalesha \\
...
\begin{flushleft}
  ...
  हे रूप चिद्रुप तद्रूप दावी निर्धारी. जय.॥4॥ \\
  \rule{\linewidth}{1pt} \\
...
\begin{flushleft}
  ...
  \rule{\linewidth}{1pt} \\
  जयदेव जयदेव जय श्री गुरुदत्ता, ओ स्वामी अवधूता।\\ आरती ओवाळिता हरली भवचिंता। जय देव जय देव।
  \rule{\linewidth}{1pt} \\
  ...
  \pagebreak
  \subsection*{english}
  trigunatmak traimurti datta ha janaa \\ triguni avatar trelokya rana \\ neti neti shabd na ye anumana \\ suravar munijan yogi samadhi na ye dhyana \\
  \rule{\linewidth}{1pt} \\
  jai dev jai dev jai shri gurudatta, o swami avadhoota \\ arati owalita harali bhavachinta. jai dev jai dev
  \rule{\linewidth}{1pt} \\
  sabahy abhyantari tu ek datta \\ abhagyasi kainchi kalel he mata \\ para he paratali teth kaincha ha het \\ janmaramanyacha purlase ant. jai dev jai dev
  \rule{\linewidth}{1pt} \\
  datt yeuniya ubha thakala \\ sadbhave sashtang pranipat kela \\ prasann houniya ashirvad dikhala \\ janmaramanyacha fera chukvila. jai dev jai dev
  \rule{\linewidth}{1pt} \\
  datt datt aise lagale dhyana \\ harpale man jhale unmana \\ mitunpanachi jhali bolavan \\ eka janardani shri datt dhyana. jai dev jai dev
\end{flushleft}
\pagebreak
\chapter{विठ्ठलाची आरती(Vitthalachi Aarti)}
\begin{flushleft}
  \subsection*{marathi}
  येई हो विठ्ठले माझे माऊलीये ।।ध्रु.।।\\
  ...
  \pagebreak
  \subsection*{english}
  yei ho viththale majhe mauli ye ।।ध्रु.।।\\
  yei ho viththale majhe mauli ye ।।\\
  nidhalavari kar, thevuni vat mi pahei, thevuni vat mi pahei ।।\\
  yei ho viththale majhe mauli ye ।।ध्रु.।।\\
  yei ho viththale majhe mauli ye ।।\\
  aliya-goliya hati dhadi niropan ।।\\
  aliya-goliya hati dhadi niropan ।।\\
  pandharpuri aahe mazza maybapa, mazza maybapa ।।\\
  yei ho viththale majhe mauli ye ।।ध्रु.।।\\
  yei ho viththale majhe mauli ye ।।\\
  pivala pitambar kaisa gagani jhalakalaa ।।\\
  pivala pitambar kaisa gagani jhalakalaa ।।\\
  garudavari basuni mazza kaivari ala, mazza kaivari ala ।।\\
  yei ho viththale majhe mauli ye ।।ध्रु.।।\\
  yei ho viththale majhe mauli ye ।।\\
  vithobache rajya amha nitya dipavali ।।\\
  vithobache rajya amha nitya dipavali ।।\\
  vishnudas nama jive-bhave ovali, jive-bhave ovali ।।\\
  yei ho viththale majhe mauli ye ।।ध्रु.।।\\
  yei ho viththale majhe mauli ye ।।\\
\end{flushleft}
\pagebreak
